...
# Stepwise Regression
library(MASS)
fit <- lm(GRAD_DEBT_MDN_SUPP~GT_25K_P6+C150_4_POOLED_SUPP+C150_L4_POOLED_SUPP+GT_25K_P6+MD_EARN_WNE_P10+NPT4_PRIV+NPT4_PUB+NPT41_PRIV+NPT41_PUB+NPT42_PRIV+ NPT42_PUB+NPT43_PRIV+NPT43_PUB+NPT44_PRIV+NPT44_PRIV+NPT44_PUB+NPT45_PRIV+NPT45_PUB+PCTFLOAN+PCTPELL+PPTUG_EF+PREDDEG+RELAFFIL+RET_FT4+RET_FTL4+ RET_PT4+RET_PTL4+RPY_3YR_RT_SUPP+UGDS) 
summary(fit)
